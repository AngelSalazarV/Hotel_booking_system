...
import Modal from '../ModalsHotel/ModalHabitaciones';

function DataTableHabitaciones() {
  ...
  return (
    <div className=' py-6 px-7 w-full flex flex-col rounded-lg overflow-hidden bg-white dark:bg-gris-oscuro dark:text-gray-200'>
      <div >
        <button className='bg-blue-600 text-white py-2 px-4 rounded-lg mb-2 hover:bg-blue-700' onClick={handleClickOpenModal} >Añadir Categoria</button>
...
export default DataTableHabitaciones;