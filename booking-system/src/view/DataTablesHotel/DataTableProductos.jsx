...
import Modal from '../ModalsHotel/ModalOrdenes'

export default function DefaultDataProductos() {
    ...
    return (
      <div className=' py-6 px-7 w-full flex flex-col rounded-lg overflow-hidden bg-white dark:bg-gris-oscuro dark:text-gray-200'>
        <div>
          <button className='bg-blue-600 text-white py-2 px-4 rounded-lg mb-2 hover:bg-blue-700' onClick={handleClickOpenModal}>Agregar Producto</button>
