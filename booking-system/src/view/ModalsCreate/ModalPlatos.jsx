...
import { validationPlatos } from '../../utils/validation';
...
export default function Modal({ isOpen, onClose, onAddOrder}) {
  const [form, setForm] = useState({
   ...
   //estado para validar campos incorrectos
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    if(Object.keys(error).length !== 0) alert('Debe llenar correctamente los campos')
    setErrorText('')
