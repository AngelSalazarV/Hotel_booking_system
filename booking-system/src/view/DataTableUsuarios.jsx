...
import { dataClientes } from '../utils/dataClientes'
...
export default function DefaultDataUsuarios() {
    ...
    return (
      <div className=' py-6 px-7 w-full flex flex-col rounded-lg overflow-hidden bg-white dark:bg-gray-700 dark:text-gray-200'>
        <div>
          <button className='bg-blue-600 text-white py-2 px-4 rounded-lg mb-2 hover:bg-blue-700' onClick={handleClickOpenModal}>Agregar Usuario</button>
